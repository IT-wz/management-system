...
<script>
    function deleteById() {
        var id = getCheckId()
        if (id) {
            var url = "${pageContext.request.contextPath}/system/dept/preDelete.do?id=" + id
            $.get(url, null, function (data) {
                if (data.length > 0) {
                    ...
                    alert("当前部门下还有子部门[" + name + "]存在,请先删除子部门")
                } else {
                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <shiro:hasPermission name="新增部门"></shiro:hasPermission>
